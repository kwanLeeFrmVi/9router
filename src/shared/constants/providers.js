...
export const APIKEY_PROVIDERS = {
  ...
  vertex: { id: "vertex", alias: "vx", name: "Vertex AI (Gemini)", icon: "cloud", color: "#4285F4", textIcon: "VX", website: "https://cloud.google.com/vertex-ai" },
  "vertex-partner": { id: "vertex-partner", alias: "vxp", name: "Vertex AI (Partner Models)", icon: "cloud", color: "#34A853", textIcon: "VP", website: "https://cloud.google.com/vertex-ai/generative-ai/docs/partner-models/use-partner-models" },
};
